...
describe Dessert do
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      brownie.ingredients = ["flour", "eggs", "sugar", "chocolate"]
      brownie.mix!
      expect(brownie.ingredients).to_not eq(["flour", "eggs", "sugar", "chocolate"])
      expect(brownie.ingredients.sort).to eq(["flour", "eggs", "sugar", "chocolate"].sort)
    end
  end
  ...
  describe "#eat" do
    ...
    it "raises an error if the amount is greater than the quantity" do
      expect{brownie.eat(120)}.to raise_error("not enought left!")
    end
